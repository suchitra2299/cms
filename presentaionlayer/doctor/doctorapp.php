...
<body>
	...
	<h1 style="margin-left:35% ;margin-top:80px"   class="asd">My Appointments</h1>
	<br><br>
	...
	<table class="table2">
		...
		$sql3=mysqli_query($connection,"SELECT  * FROM  bookapp WHERE docID=('$doctorid') ") ;
		...
		else
		{
			...
			while ($row3=mysqli_fetch_row($sql3)) {
				...
				echo "<tr><td>".$row3[0]."</td><td>".$row3[1]."</td><td>".$row3[2]."</td><td>".$row3[3]."</td><td>".$row3[4]."</td><td>".$row3[6]."</td></tr>";			}
